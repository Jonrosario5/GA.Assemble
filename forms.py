...
from wtforms import StringField, PasswordField, TextAreaField, DateTimeField, BooleanField,SelectField, SubmitField, SelectMultipleField
...
class User_Topics(Form):
    ...
    #     form = User_Topics(request.POST, obj=request.Post)
